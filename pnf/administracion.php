...
$redireccion = 'administracion(usuario).php';
include("../control/validacion(usuario).php");
$consulta = $conexion->query("SELECT * FROM administracion where estado = 'Habilitado' order by trayecto asc ");
    ...
    <h2>Administración</h2>
        <table class="tablasearch">
            ...
            <tr>
                ...
                <td><a href="edit.php?direccion=administracion.php&&id=<?php echo $mostrar['id']?>&&idpnf=<?php echo $mostrar['idpnf']?>">Editar</a></td>
                <td><a href="inhabilitar.php?id=<?php echo $mostrar['id']?>&direccion=administracion">Inhabilitar</a></td>
            </tr>
            <?php  } ?>
        </table>
