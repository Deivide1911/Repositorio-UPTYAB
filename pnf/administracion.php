...
<header class="logo">
    ...
    <h2 class="h2informatica">Administración</h2>
    <div class="center">
    ...
    <?php while($mostrar = mysqli_fetch_array($consulta)){
            ?>
                <div class="container-frames">
                    ...
                    <a class="blueone2" href="inhabilitar.php?id=<?php echo $mostrar['id']?>&direccion=administracion.php&idpnf=<?php echo $mostrar['idpnf']?>">Inhabilitar</a>
