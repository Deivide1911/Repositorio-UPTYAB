...
$redireccion = 'avanzada(usuario).php';
include("../control/validacion(usuario).php");
$consulta = $conexion->query("SELECT * FROM avanzada where estado = 'Habilitado' order by trayecto asc ");
...
<header class="logo">
    ...
    <div class="center">
        ...
        <a href="inhabilitados.php?direccion=avanzada.php" class="linkupload">Ver proyectos eliminados</a>
    </div>
    ...
    <h2>PNF Avanzada</h2>
        <table class="tablasearch">
            ...
            <tr>
                ...
                <td><a href="edit.php?direccion=avanzada.php&&id=<?php echo $mostrar['id']?>&&idpnf=<?php echo $mostrar['idpnf']?>">Editar</a></td>
                <td><a href="inhabilitar.php?id=<?php echo $mostrar['id']?>&direccion=avanzada">Inhabilitar</a></td>
            </tr>
            <?php  } ?>
        </table>
