...
<header class="logo">
    ...
    <form class="config-container" method="post" action="config.php">
        ...
        <input class="inputios" value="<?=$snombre?>"  type="text" name="snombre" id="segundo-nombre" placeholder="Segundo Nombre (En caso de no tener dejar así)">
        ...
        <input class="inputios" value="<?=$sapellido?>"  type="text" name="sapellido" id="segundo-apellido" placeholder="Segundo Apellido (En caso de no tener dejar así)">
