    ...
    <h2>Enfermería</h2>
        <table class="tablasearch">
            ...
            <tr>
                ...
                <td><a href="edit.php?direccion=enfermeria.php&&id=<?php echo $mostrar['id']?>&&idpnf=<?php echo $mostrar['idpnf']?>">Editar</a></td>
                <td><a href="inhabilitar.php?id=<?php echo $mostrar['id']?>&direccion=enfermeria">Inhabilitar</a></td>
            </tr>
            <?php  } ?>
        </table>
