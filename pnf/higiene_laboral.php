...
<head>
    ...
    <title>Higiene & Seguridad Laboral</title>
    ...
    <?php while($mostrar = mysqli_fetch_array($consulta)){
            ?>
                <div class="container-frames">
                    ...
                    <a class="blueone2" href="inhabilitar.php?id=<?php echo $mostrar['id']?>&direccion=higiene_laboral.php&idpnf=<?php echo $mostrar['idpnf']?>">Inhabilitar</a>
