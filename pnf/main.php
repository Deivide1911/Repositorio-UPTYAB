...
<body>
    <header class="logo">
        <a href="main.html"><img src="../img/logomin.png" alt="logo" width="150px" height="70px"></a>
        <nav class="dropmenu">
        <ul>
            <li><p class="re"><a href="#" ><i class="fa-solid fa-bars"></i> Selecciona un PNF</p></li>
            <li>
        <ul class="contenido">
            <li><a href="#" class="pnf"><i class="fa-solid fa-laptop-code"></i> PNF Informatica</a></li>
    ...
    <?php 
    include("../control/validarsalir.php");
    ?>  
</body>
</html>